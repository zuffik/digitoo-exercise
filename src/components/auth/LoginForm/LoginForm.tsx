...
const validationSchema = Yup.object({
    ...
    password: Yup.string().required('Please fill in your password').min(6, 'Password must be at least 6 characters long')
})
                    ...
                    {({touched, errors}) => (
                        <Form>
                            ...
                            <div className="text-right mt-10">
                                <Button loading={props.loading} large>Log In</Button>
                            </div>
                        </Form>
                    )}
                </Formik>
